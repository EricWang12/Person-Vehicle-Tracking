...
model_name = os.path.join(curr_dir, 'resnext-101/mal_x-101-fpn_cocomodel_0180000.pth')
transferred_model_name = os.path.join(curr_dir,'resnext-101/transferred_model_0180000.pth')
